...
class VGGnet_train(Network):
    ...
    def setup(self):
        ...
        (self.feed('rpn_conv/3x3')
             .conv(1,1, _num_anchors * 4, 1, 1, padding='VALID', relu = False, name='rpn_bbox_pred'))  ## benz, hand-coding, len(anchor_scales) * 3
        (self.feed('rpn_conv/3x3')
             .conv(1, 1, _num_anchors * 2, 1, 1, padding='VALID', relu=False, name='rpn_cls_score'))  ## benz,len(anchor_scales) * 3
        ...
        (self.feed('rpn_cls_prob')
             .spatial_reshape_layer( _num_anchors * 2, name = 'rpn_cls_prob_reshape'))   ## benz,len(anchor_scales) * 3
